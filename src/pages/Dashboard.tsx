...
const Dashboard = () => {
    ...
    switch (activeSection) {
      ...
      case "retrospectives":
        return (
          <Card className="bg-white/10 backdrop-blur-md border-white/20">
            <CardHeader>
              <CardTitle className="text-white">Gerenciamento de Retrospectivas</CardTitle>
            </CardHeader>
            <CardContent>
              <p className="text-white/80">Funcionalidade em desenvolvimento...</p>
            </CardContent>
          </Card>
        );
  ...
  return (
    <SidebarProvider>
      <div className="min-h-screen bg-gradient-to-br from-purple-900 via-blue-900 to-indigo-900 flex w-full">
        <DashboardSidebar 
